...
- [x] IN-02.1b — Resilience: timeout/retry/jitter, connection pooling, circuit breaker
- [x] IN-02.2a — Slot search mapping (paging, filters, TZ-safe windows)
- [x] IN-02.2b — Contract validators (search request/response schemas; codegen + compiled validators)
...
- [x] IN-02.5 — FHIR write-back links for created appointments (Task update; references; audit)
- [x] IN-02.6 — Observability: latency histograms, error/conflict rates, spans; correlation propagation
- [x] IN-02.7 — Backpressure & rate limits (adapter-level caps; 429/503 mapping)
- [x] IN-02.14 — Performance baselines (search/create p50/p95; pooling/keep-alive budgets)
